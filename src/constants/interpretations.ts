...
const interpretations: any = [
  {
    ...
    aspect2: {
      ...
      veryLow: {
        ...
        part2: "People very low in interest in ideas do not seek out or develop new or creative ideas, finding it difficult to adapt to new experiences and situations. However, the opposite is true, they are more likely to be incredible proficient and skilled in traditional methods and ideas.",
        part3: "People very low in interest in ideas do not like complex occupations and are better suited for straightforward and traditional occupations, where the rules for success are well-defined and tend not to change.",
        part4: "Women are lower than men in in ideas (although not in IQ).",
      ...
      low: {
        ...
        part2: "People low in interest in ideas do not seek out or develop new or creative ideas, finding it difficult to adapt to new experiences and situations. However, the opposite is true, they are more likely to be incredible proficient and skilled in traditional methods and ideas.",
        part3: "People low in interest in ideas do not like complex occupations and are better suited for stable, straightforward and traditional occupations, where the rules for success are well-defined and tend not to change.",
        part4: "Women are lower than men in in ideas (although not in IQ).",
        part5: "Note: Do not confuse the personality aspect with IQ. This aspect measures interest in abstract ideas, while IQ is a measure of processing speed, verbal ability, working memory, and problem-solving capacity, and is better measured with a formal IQ test. It is perfectly possible to have a high IQ and a low score on the personality trait of interest in ideas (or the reverse).",
      },
      modLow: {
      ...
      modHigh: {
        part1: "People with moderately high levels of interest in ideas enjoy learning and engaging in novel information, even when it is complex. They are curious and exploratory and like to tackle and solve problems. They engage, seek, and initiate issue-oriented discussions.",
      ...
      high: {
        part1: "People high in interest in ideas enjoy learning and engaging in novel information, even when it is complex (which they may prefer). They are very curious and exploratory, and like to tackle and solve problems. They engage, seek, and initiate issue-oriented discussions.",
        part2: "They read, think, and want to discuss information they consume (most frequently non-fiction), which also makes them articulate and allows them to formulate ideas clearly and quickly (especially if high in extraversion).",
      ...
      veryHigh: {
        part1: "People with very high levels of interest in ideas enjoy learning and engaging in novel information, even when it is complex (which they might prefer). They are very curious and exploratory, and like to tackle and solve problems. They engage, seek, and initiate issue-oriented discussions.",
        part2: "They read, think, and want to discuss information they consume (most frequently non-fiction), which also makes them articulate and allows them to formulate ideas clearly and quickly (especially if high in extraversion).",
