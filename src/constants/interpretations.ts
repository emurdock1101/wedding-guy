...
const interpretations: any = [
  {
    ...
    aspect1: {
      ...
      modHigh: {
        ...
        part3: "They have a powerful imagination, which means they can get lost reflecting on things. They moved by music, books, movies, and any other form of stories to the point that they may be oblivious to the outside world. They respond very strongly to beauty, creativity and art and may be creative themselves in those areas, collecting or creating artistic reminders of creativity.",
        part4: "Note: The higher the aesthetic openness, the more impractical or flighty they may be (especially if low in conscientiousness). The means they may have a very hard time monetizing their creativity or turning it into a career.",
  ...
  },
  {
    ...
    aspect1: {
      ...
      veryLow: {
        ...
        part3: "People very low in enthusiasm keep people further away and more concerned with keeping things private. They will view life (past, present, and future) less positivity and optimism. If high in openness, it may be difficult to showcase your work or preform your work for groups.",
      ...
      low: {
        ...
        part3: "People low in enthusiasm keep people further away and are more concerned with keeping things private. They will view life (past, present, and future) less positivity and optimistic. If high in openness, it may be difficult to showcase your work or preform your work for groups.",
      ...
      modLow: {
        ...
        part3: "People moderately low in enthusiasm keep people further away and are more concerned with keeping things private. They will view life (past, present, and future) less positivity and optimistic. If high in openness, it may be difficult to showcase your work or preform your work for groups.",
        part4: "Note: The lower the enthusiasm the less stimulation, excitement, activity, and fun are desired.  In relationships, you may come across as uninterested, lacking an opinion, or have a level of disinterestedness that may make people think you are not interested in them. Maladaptive levels of enthusiasm can come across as mania. Being lower in the enthusiasm doesn’t mean that you are sad. It means that the way you express positive emotions may be muted compared to those that are high in enthusiasm.",
        part5: "Women are higher in enthusiasm than men.",
      },
      average: {
      ...
      modHigh: {
        ...
        part3: "People moderately high in enthusiasm keep people close and tend to share more details than less enthusiastic people. They will view life (past, present, and future) positive and optimistic (if high in neuroticism they will be more prone to having “higher highs” and “lower lows”).",
      ...
      veryHigh: {
        ...
        part3: "People very high in enthusiasm keep people very close and keep very little private. They will view life (past, present, and future) very positive and optimistic (if high in neuroticism they will be more prone to going through “higher highs” and “lower lows”).",
        part4: "Note: The higher the enthusiasm the more stimulation, excitement, activity, and fun are desired.  In relationships you may be considered dramatic or opinionated. Maladaptive levels of enthusiasm can come across as mania.",
        part5: "Women are higher in enthusiasm than men.",
      },
    },
